...
let [e, pi, gravedad, humanBodyTemp, qaterBoilingTemp] = constants;

console.log(e, pi, gravedad, humanBodyTemp, qaterBoilingTemp);
...
let countriesObjet={...couuntries};

console.log(countriesObjet);
